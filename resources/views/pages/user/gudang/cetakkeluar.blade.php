...
<main>
  <div class="container py-4">
    ...
    <div class="row align-items-md-stretch mb-2">
          ...
          <div><center style="font-size: 18px; font-weight: bold;">PENGELUARAN KANTONG DARAH </center> </div>
          <br/>
          <br/>
          ...
          <div style="display: flex;">
            <div style="width: 80%;">
              <!-- Kiri -->
               <div style="text-align: left; font-weight: bold;"> NO TRANSAKSI :  {{$get->notrans}}</div>
               <div style="text-align: left; font-weight: bold;"> TANGGAL KELUAR :  {{$get->tgltrans}}</div>
            </div>
            <div style="width: 80%;">
              <!-- Kanan -->
               <div style="text-align: right; font-weight: bold;"> NO PERMINTAAN :  {{$get->nopermintaan}}</div>
               <div style="text-align: right; font-weight: bold;"> TANGGAL PERMINTAAN : 
                 @foreach($getminta as $item) 
                    @if ($loop->first)
                          {{$item->tglminta}} 
                    @endif
          ...
          <div class="ttd-container">
            <!-- TTD Kiri -->
            <div class="ttd-box">
              <div class="">Petugas Yang Mengeluarkan</div>
            ...
            <!-- TTD Kanan -->
            <div class="ttd-box">
              <div class="">Petugas Yang Menerima</div>
              <div class="ttd-line"></div>
