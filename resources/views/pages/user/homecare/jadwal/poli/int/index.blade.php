...
<div class="page-body" id="main-content">
    ...
    <div class="space-y">
            ...
            <div class="alert alert-danger"><h2>Jadwal Dokter Penyakit Dalam</h2></div>
                            <div class="card">
                    <div class="row g-0">
                        <div class="col-auto">
                            <div class="card-body">
                        ...
                        <div class="col">
                            <div class="card-body ps-0">
                                <div class="row">
                                    <div class="col">
                                        <h3 class="mb-0"><a href="#">dr. Atina Irana Wira Putri Sp.PD.</a></h3>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md">
                                        <div class="list-inline list-inline-dots mb-0 text-muted d-sm-block">
                                            <div class="list-inline-item">
                                                <h4 class="mb-0 text-danger">Poli Spesialis Penyakit Dalam</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-auto">
                                        <div class="mt-1">
                                            <a href="#" class="badge bg-blue border fw-normal pt-1">
                                                SENIN  - 08:00:00-10:00:00 <br/><br/>
                                                SELASA - 08:00:00-10:00:00 <br/><br/>
                                                RABU   - 08:00:00-10:00:00
                                            </a>
                                        </div>
                                    </div>
                                </div>
