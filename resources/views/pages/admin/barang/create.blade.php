                    ...
                    <div class="col-12">
                        <div class="row mt-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" value="{{ old('kdbrg') }}" class="form-control @error('kdbrg') is-invalid @enderror" name="kdbrg" id="kdbrg" {{-- placeholder="John Doe" --}} aria-describedby="defaultFormControlHelp" />
                                @error('kdbrg')
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" value="{{ old('nmbrg') }}" class="form-control @error('nmbrg') is-invalid @enderror" name="nmbrg" id="nmbrg" {{-- placeholder="John Doe" --}} aria-describedby="defaultFormControlHelp" />
                                @error('nmbrg')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
                                </span>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" value="{{ old('satuanbsr') }}" class="form-control @error('satuanbsr') is-invalid @enderror" name="satuanbsr" id="satuanbsr" {{-- placeholder="John Doe" --}} aria-describedby="defaultFormControlHelp" />
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" value="{{ old('stok') }}" class="form-control @error('stok') is-invalid @enderror" name="stok" id="stok" {{-- placeholder="John Doe" --}} aria-describedby="defaultFormControlHelp" />
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" value="{{ old('stokmin') }}" class="form-control @error('stokmin') is-invalid @enderror" name="stokmin" id="stokmin" {{-- placeholder="John Doe" --}} aria-describedby="defaultFormControlHelp" />
                                @error('stokmin')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
                                </span>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ old('hrsat') }}" class="form-control @error('hrsat') is-invalid @enderror" name="hrsat" id="hrsat" {{-- placeholder="John Doe" --}} aria-describedby="defaultFormControlHelp" />
                                    @error('hrsat')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
