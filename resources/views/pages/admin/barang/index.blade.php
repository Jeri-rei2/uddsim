...
<div class="d-flex justify-content-between flex-column flex-sm-row">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Barang</h4>
    <div class="py-3">
            ...
            <table id="example" class="display table table-bordered py-3 table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$item->kdbrg}}</td>
                        <td>{{$item->nmbrg}}</td>
                        <td>{{$item->satuanbsr}}</td>
                        <td>@currency($item->hrsat)</td>
                        <td>{{$item->stok}}</td>
                        <td>{{$item->stokmin}}</td>
                        <td>{{$item->stokawal}}</td>
                        <td>{{$item->jnsbrg}}</td>
                        ...
                        <td class="d-flex justify-content-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{route('barang.show', $item->id)}}" class="dropdown-item"><i class='bx bx-search-alt'></i> Detail</a>
