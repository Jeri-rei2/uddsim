...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pekerjaan / </span> Tambah Baru</h4>
                    ...
                    <div class="col-12">
                        <div class="row mt-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" value="{{ old('kdpkrj') }}" class="form-control @error('kdpkrj') is-invalid @enderror" name="kdpkrj" id="kdpkrj" {{-- placeholder="John Doe" --}} aria-describedby="defaultFormControlHelp" />
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" value="{{ old('nmpkrj') }}" class="form-control @error('nmpkrj') is-invalid @enderror" name="nmpkrj" id="nmpkrj" {{-- placeholder="John Doe" --}} aria-describedby="defaultFormControlHelp" />
                                @error('nmpkrj')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
                                </span>
