...
<main>
  <div class="container py-4">
    ...
    <div class="row align-items-md-stretch mb-2">
          ...
          <div><center style="font-size: 18px; font-weight: bold;">PENGELUARAN KANTONG DARAH KE MOBILE UNIT</center> </div>
          <br/>
          <br/>
        ...
        <div style="display: flex;">
            <div style="width: 80%;">
              <!-- Kiri -->
               <div style="text-align: left; font-weight: bold;"> NO Pengeluaran :  {{$get2->nopengeluaran}}</div>
               <div style="text-align: left; font-weight: bold;"> TGL Pengeluaran :  {{$get2->tglpengeluaran}} </div>
            </div>
            <!-- <div style="width: 80%;">
            ...
            <div style="width: 80%;">
              <!-- Kanan -->
               <div style="text-align: right; font-weight: bold;"> ASAL DARAH : {{$get2->kdasldrh}} </div>
               <div style="text-align: right; font-weight: bold;"> Mobil Unit : {{$get2->kdmobil}}</div>
          ...
          <div class="ttd-container">
            ...
            <!-- TTD Kanan -->
            <div class="ttd-box">
              <div class="">Petugas Penerima</div>
              <div class="ttd-line"></div>
