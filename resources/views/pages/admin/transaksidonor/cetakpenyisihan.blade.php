...
<main>
  <div class="container py-4">
    ...
    <div class="row align-items-md-stretch mb-2">
          ...
          <div><center style="font-size: 18px; font-weight: bold;">LAPORAN PENYISIHAN KANTONG</center> </div>
          <div><center style="font-size: 14px; font-weight: bold;">Priode : {{ $start }}   s/d {{ $end }} </center> </div>
