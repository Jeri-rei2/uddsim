...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Wilayah / </span> Tambah Baru</h4>
                    ...
                    <div class="col-12">
                        <div class="row mt-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" value="{{ old('kdwil') }}" class="form-control @error('kdwil') is-invalid @enderror" name="kdwil" id="kdwil" {{-- placeholder="John Doe" --}} aria-describedby="defaultFormControlHelp" />
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" value="{{ old('nmwil') }}" class="form-control @error('nmwil') is-invalid @enderror" name="nmwil" id="nmwil" {{-- placeholder="John Doe" --}} aria-describedby="defaultFormControlHelp" />
                                @error('nmwil')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{$message}}</strong>
                                </span>
