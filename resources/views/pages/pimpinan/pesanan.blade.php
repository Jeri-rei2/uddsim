...
<div class="d-flex justify-content-between flex-column flex-sm-row">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Detail Order /</span> Keluhan</h4>
    <div class="py-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($order->status == "Sudah Diperiksa")
                                        <div class="badge bg-primary text-white">{{$order->status}}</div>
                                        @else
                                    ...
                                    <td class="d-flex justify-content-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="{{route('otwperiksa', $order->id)}}">
                                                <button type="button" class="btn dropdown-item" id="pay-button">
                                                   <i class="fa fa-user-md"> </i> Periksa Sekarang
                                                </button>
                                                </a>
                                                ...
                                                <a href="{{route('pesanan.invoices', $order->order_id)}}" target="_blank" class="dropdown-item"><i class='bx bx-receipt me-1'></i> Bukti Pembayaran Pasien</a>
                                            </div>
                                        </div>
                                    </td>
