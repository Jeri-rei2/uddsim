                ...
                <div class="container">
                    <div class="col-md-12">
                        <div class="text-center">
                            <p class="pt-0 display-6">RS. SURABAYA MEDICAL SERVICE</p>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            ...
                            <ul class="list-unstyled">
                                ...
                                @foreach ($pay as $pays)
                                @if ($pays->status == "Belum Dibayar")
                                <div class="badge bg-danger text-white">{{$pays->status}}</div>
                                @elseif($pays->status == "Sudah Dibayar")
                                <div class="badge bg-warning text-white">{{$pays->status}}</div>
                                @else
                                <div class="badge bg-success text-white">{{$pays->status}}</div>
                                @endif
                                @endforeach
                                </span></li>
                            </ul>
